 ...
 * <p>
 * This listener is part of the observer pattern implementation for the Tower Defense game. Classes implementing this interface can register
 * with the Board class to receive notifications about state changes and game events.
 *
 * @author feljo718
 * @see Board
 */
public interface BoardListener
{
     ...
     * <p>
     * This method is invoked when the player loses all lives. Implementations should handle the game over state appropriately, such as
     * displaying a game over screen or stopping game processes.
     */
    void gameOver();
